...
# Github link : https://github.com/simk2020/E-Commerce-BackEnd.git 
...
* Repository contains a quality readme with description and a link to a walkthrough video.

## Review

You are required to submit BOTH of the following for review:

* A walkthrough video demonstrating the functionality of the application and all the acceptance criteria being met.
